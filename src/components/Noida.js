  ...
  const [data,setData] = useState(countries)
    ...
    return(
      <View style={styles.containner} >
       <Text style={styles.heading}>Country Drown</Text>

       <TouchableOpacity style = {styles.dropdown} onPress={()=>{
        setIsClicked(!isClicked)
       }}>
<Text  style={{fontSize:20,fontWeight:'normal',fontFamily:'Roboto-Regular.ttf'}}> {SelectedCountry}</Text>
{isClicked ? (
  <Image source={require('../assets/img/upload.png')} style={styles.ican}/>

):   ( <Image source={require('../assets/img/dropdown.png')} style={styles.ican}/>
)}
